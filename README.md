...
✅ Props used to pass the title

✅ useState hook for managing dark mode
...
When the button is clicked, the state toggles between true and false.

Based on the state, background and text colors change dynamically.
